...
if __name__ == "__main__":
    ...
    parser.add_argument("--LM_config", type=str, default="reason/resource/qwen2.5/config.json")
    ...
    parser.add_argument("--use_lora", action="store_true", help="whether to use lora adapter for generation")
